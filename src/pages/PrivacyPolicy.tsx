    ...
    <div className="min-h-screen bg-gray-50 pt-20">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <h1 className="adsimple-312925588 text-3xl font-bold text-gray-900 mb-6">
            Datenschutzerklärung
          </h1>

          <h2
            id="einleitung-ueberblick"
            className="adsimple-312925588 text-2xl font-semibold mt-6 mb-2"
          >
            Einleitung und Überblick
          </h2>
          <p>
            Wir haben diese Datenschutzerklärung (Fassung 26.12.2024-312925588)
            verfasst, um Ihnen gemäß der Vorgaben der{' '}
            <a
              className="adsimple-312925588"
              href="https://eur-lex.europa.eu/legal-content/DE/TXT/HTML/?uri=CELEX:32016R0679&from=DE&tid=312925588#d1e2269-1-1"
              target="_blank"
              rel="noopener"
            >
            ...
            <br />
            <strong className="adsimple-312925588">Kurz gesagt:</strong> Wir
          ...
          <p>
            ...
            werden technische{' '}
            <strong className="adsimple-312925588">
              Begriffe leserfreundlich erklärt
            </strong>
            , Links zu weiterführenden Informationen geboten und{' '}
            <strong className="adsimple-312925588">Grafiken</strong> zum Einsatz
          ...
          <ul className="adsimple-312925588 list-disc list-inside ml-4 my-3">
          ...
          <p>
            <strong className="adsimple-312925588">Kurz gesagt:</strong> Die
            Datenschutzerklärung gilt für alle Bereiche, in denen
            personenbezogene Daten im Unternehmen über die genannten Kanäle
            strukturiert verarbeitet werden. Sollten wir außerhalb dieser Kanäle
          ...
          <ol className="list-decimal list-inside ml-4 my-3">
            <li className="adsimple-312925588">
              <strong className="adsimple-312925588">Einwilligung</strong> (Artikel
            ...
            <li className="adsimple-312925588">
              <strong className="adsimple-312925588">Vertrag</strong> (Artikel 6
            ...
            <li className="adsimple-312925588">
              <strong className="adsimple-312925588">Rechtliche Verpflichtung</strong>{' '}
            ...
            <li className="adsimple-312925588">
              <strong className="adsimple-312925588">Berechtigte Interessen</strong>{' '}
          ...
          <ul className="adsimple-312925588 list-disc list-inside ml-4 my-3">
            <li className="adsimple-312925588">
              In <strong className="adsimple-312925588">Österreich</strong> ist dies
              das Bundesgesetz zum Schutz natürlicher Personen bei der
              Verarbeitung personenbezogener Daten (
              <strong className="adsimple-312925588">Datenschutzgesetz</strong>),
              kurz <strong className="adsimple-312925588">DSG</strong>.
            </li>
            <li className="adsimple-312925588">
              In <strong className="adsimple-312925588">Deutschland</strong> gilt
              das <strong className="adsimple-312925588">Bundesdatenschutzgesetz</strong>,
              kurz <strong className="adsimple-312925588">BDSG</strong>.
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            des Verantwortlichen gemäß Artikel 4 Absatz 7 EU-Datenschutz-Grundverordnung
            (DSGVO):
            <br />
            <span className="adsimple-312925588" style={{ fontWeight: 400 }}>
              FR Innovative Haustechnik
              <br />
              Felix Reinhold
              <br />
              Albert-Schweitzer-Straße 5, 63110 Rodgau
            </span>
            <br />
            <span style={{ fontWeight: 400 }}>
              Vertretungsberechtigt: Felix Reinhold
            </span>
            <br />
            E-Mail:{' '}
            ...
            <br />
            Telefon:{' '}
            <a href="tel:+49 176 61986416">+49 176 61986416</a>
            <br />
            Impressum:{' '}
            <a href="https://www.fr-innovative-haustechnik.de/impressum">
              https://www.fr-innovative-haustechnik.de/impressum
            </a>
          </p>
          ...
          <p>
            <strong className="adsimple-312925588">Kurz gesagt:</strong> Sie
            haben Rechte – zögern Sie nicht, die oben gelistete verantwortliche
          ...
          <p>
            ...
            <a
              className="adsimple-312925588"
              href="https://www.dsb.gv.at/?tid=312925588"
              target="_blank"
              rel="noopener"
            >
              https://www.dsb.gv.at/
          ...
          <p>
            ...
            <br />
            <strong className="adsimple-312925588">Adresse: </strong>
            Postfach 31 63, 65021 Wiesbaden
            <br />
            <strong className="adsimple-312925588">Telefonnr.:</strong> 06
            11/140 80
            <br />
            <strong className="adsimple-312925588">E-Mail-Adresse:</strong>{' '}
            <a
              className="adsimple-312925588"
            ...
            <br />
            <strong className="adsimple-312925588">Website: </strong>
            <a
              className="adsimple-312925588"
              href="https://datenschutz.hessen.de/?tid=312925588"
              target="_blank"
              rel="noopener"
            >
