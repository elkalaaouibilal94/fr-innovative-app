...
interface BadSanierungGalleryProps {
  images: ProjectImage[];
}

const BadSanierungGallery: React.FC<BadSanierungGalleryProps> = ({
  images,
}) => {
  const [currentIndex, setCurrentIndex] = useState(0);
  const [selectedImage, setSelectedImage] = useState<ProjectImage | null>(null);
  const [, setViewerIndex] = useState(0);
...
export default BadSanierungGallery;
